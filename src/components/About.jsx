    ...
    <section className="py-20 max-w-7xl mx-auto px-6 relative" id="about">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
        <div className="relative flex justify-center group">
          ...
          <div className="relative w-64 h-64 md:w-80 md:h-80 rounded-full overflow-hidden border-4 border-white dark:border-surface-dark shadow-2xl">
            <img
        ...
        <div className="space-y-6">
          <h3 className="font-display font-bold text-2xl md:text-3xl text-primary dark:text-secondary">
          ...
          <div className="flex flex-col gap-4 mt-8">
            <div className="group flex items-center p-4 rounded-xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-surface-dark hover:border-primary/50 dark:hover:border-primary/50 transition-all cursor-default shadow-sm hover:shadow-md hover:shadow-primary/10">
            ...
            <div className="group flex items-center p-4 rounded-xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-surface-dark hover:border-secondary/50 dark:hover:border-secondary/50 transition-all cursor-default shadow-sm hover:shadow-md hover:shadow-secondary/10">
            ...
            <div className="group flex items-center p-4 rounded-xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-surface-dark hover:border-purple-400/50 dark:hover:border-purple-400/50 transition-all cursor-default shadow-sm hover:shadow-md hover:shadow-purple-400/10">
